...
namespace Entitas {
    ...
    public class Entity : IEntity {
        ...
        public delegate void EntityRetainedEvent(IEntity entity, object owner);

        /// Occurs when entity is retained, even if retained before.
        public event EntityRetainedEvent OnEntityRetained;
#endif
